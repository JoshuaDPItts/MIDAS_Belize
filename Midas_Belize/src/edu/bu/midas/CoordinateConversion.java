...
public class CoordinateConversion
{
	...
	*/
	public double[] utm2LatLon(int zone, String latZone, double estng, double nrthng) 
	{
		UTM2LatLon c = new UTM2LatLon();
		return c.convertUTMToLatLong(zone, latZone, estng, nrthng);
	}
	...
	private class UTM2LatLon
	{
		...
		// Modified by Chris Holden to use seperate values as UTM
		//public double[] convertUTMToLatLong(String UTM)
		public double[] convertUTMToLatLong(int zone, String latZone, double estng, double nrthng)
		{
			double[] latlon = { 0.0, 0.0 };
			/*
